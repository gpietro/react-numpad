...
test('Number validator factory (fixed=false, sign=false)', () => {
...
test('Number validator factory (fixed=true, sign=false)', () => {
...
test('Number validator factory (fixed=false, sign=true)', () => {
...
test('Number validator factory (fixed=true, sign=true)', () => {
