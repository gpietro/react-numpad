...
const GridItem = styled.div`
    ...
    color: ${ props => props.prevMonth || props.nextMonth ? props.theme.color.light : ''};
    background: ${ props => props.active ? props.theme.color.secondary : ''};
    flex: 0 14.28571%;
    text-align: center;
    border-right: none;
    border-bottom: 1px solid #ddd;
    border: ${ props => props.weekDays ? 'none' : ''};
    padding: ${ props => props.weekDays ? '0.2em' : '0.25rem'};
    font-size: ${ props => props.weekDays ? '0.8em' : ''};
    :nth-child(-n+7) {
        border-top: ${ props => props.weekDays ? '' : '1px solid #ddd'};
    }
    display: flex;
    flex-direction: column;
