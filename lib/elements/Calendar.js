...
const DayGridItem = GridItemLink.extend`
  ${props =>
    props.prevMonth || props.nextMonth
      ...
      : `color: ${props.theme.color.primary};`} text-decoration: none !important;
  cursor: pointer;
  &:hover {
    ${props => (props.active ? '' : `color: ${props.theme.color.secondary}`)};
  }
  &[disabled] {
    color: ${props =>
  ...
  ${props =>
    ...
    &::after {
      border-width: 0.5em;
      border-right-color: #31c69f;
      border-top-color: #31c69f;
    }`
      : ``};
`;
