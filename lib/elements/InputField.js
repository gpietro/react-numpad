...
const getInputCoords = input => {
  if (input && input.isReactComponent) {
    console.log('...', ReactDOM.findDOMNode(input).getBoundingClientRect());
    return ReactDOM.findDOMNode(input).getBoundingClientRect();
  } else if (input) {
