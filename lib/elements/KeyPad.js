...
class KeyPad extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <div style={{display: 'flex', fontSize: '1.2em', justifyContent: 'space-between', borderBottom: '1px solid #ddd', padding: '5px'}}>
                    <i style={{cursor: 'pointer', color: '#00d8ff'}} 
                       onClick={cancel} 
                       className="fa fa-remove"/>
                    <div style={{ fontWeight: 700, fontSize: '0.8em'}}>{label}</div>
                    <i style={{cursor: 'pointer', color: '#00d8ff'}} 
